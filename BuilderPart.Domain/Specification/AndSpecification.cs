...
namespace BuilderPart.Domain.Specification
{
    internal class AndSpecification<T> : Specification<T>
    {
        ...
        public override Expression<Func<T, bool>> ToExpression()
        {
            ...
            var rebindParameterVision = new ParameterReplacer(rightExpression.Parameters[0], leftExpression.Parameters[0]);
            var right = rebindParameterVision.Visit(rightExpression.Body);
